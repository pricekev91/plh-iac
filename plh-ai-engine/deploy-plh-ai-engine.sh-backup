...
configure_lemonade() {
    ...
    # Write ~/.config/lemonade/config.json directly.
    # The PPA CLI (lemonade config set) doesn't support dotted keys,
    # but editing the JSON file directly is the supported approach.
